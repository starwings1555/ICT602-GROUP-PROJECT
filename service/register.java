...
public class register extends AppCompatActivity {
    public static final String SERVICE_CENTRE = "service";
                ...
                .requestLocationUpdates(locationRequest, new LocationCallback() {
                    ...
                    public void onLocationResult(@NonNull LocationResult locationResult) {
                        ...
                        if (locationResult != null && locationResult.getLocations().size() > 0) {
                            ...
                            DatabaseReference reference2 = FirebaseDatabase.getInstance().getReference().child(register.LOCATION_RESTAURANTS).child(username);
                            hashMap.put("id", userId);
                            hashMap.put("username", username);
                            ...
                            Toast.makeText(register.this, "latitude : " + latitude, Toast.LENGTH_SHORT).show();
                        }
                    }
